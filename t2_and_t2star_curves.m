...
figure;
hold on;
plot(params.TE, signal_WM_T2, '-r', 'DisplayName', 'T2 = 109.77 ms (white matter)');
plot(params.TE, signal_GM_T2, '-g', 'DisplayName', 'T2 = 96.07 ms (gray matter)');
plot(params.TE, signal_WM_T2star, '-b', 'DisplayName', 'T2* = 67.63 ms (white matter)');
plot(params.TE, signal_GM_T2star, '-y', 'DisplayName', 'T2* = 48.48 ms (gray matter)');
